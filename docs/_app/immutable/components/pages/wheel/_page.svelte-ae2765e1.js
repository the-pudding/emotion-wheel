import{S as D,i as S,s as W,k as b,q as I,a as g,v as w,l as k,m as M,r as B,h as p,c as v,w as $,n as h,b as q,D as d,x as _,A as j,f as y,t as H,y as x,o as P,V as z}from"../../../chunks/index-d8564362.js";import{b as F}from"../../../chunks/paths-6cd3a76e.js";import"../../../chunks/transform-d9c6ebaf.js";import{I as G,C as J,h as K,a as N,s as C}from"../../../chunks/Icon-6ba03468.js";const O=`<svg id="the-wheel" viewBox="0 0 1150 1121" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="slices">
...
`;function Q(r){let l,L,a,f,n,Z,u,e,c,m,s,o;return c=new G({props:{name:"download"}}),s=new J({props:{slices:O,imgSrc:"assets/wheel/wheel.png",wheelId:"the-wheel"}}),{c(){l=b("div"),L=b("a"),a=I("Back to the story"),f=g(),n=b("h1"),Z=I("Hi, how are you feeling?"),u=g(),e=b("a"),w(c.$$.fragment),m=g(),w(s.$$.fragment),this.h()},l(i){l=k(i,"DIV",{class:!0});var t=M(l);L=k(t,"A",{href:!0,class:!0});var V=M(L);a=B(V,"Back to the story"),V.forEach(p),f=v(t),n=k(t,"H1",{class:!0});var A=M(n);Z=B(A,"Hi, how are you feeling?"),A.forEach(p),u=v(t),e=k(t,"A",{class:!0,download:!0,alt:!0});var E=M(e);$(c.$$.fragment,E),E.forEach(p),m=v(t),$(s.$$.fragment,t),t.forEach(p),this.h()},h(){h(L,"href","../"),h(L,"class","svelte-12hs9pv"),h(n,"class","svelte-12hs9pv"),h(e,"class","download svelte-12hs9pv"),h(e,"download",""),h(e,"alt","download your emotion wheel"),h(l,"class","container svelte-12hs9pv")},m(i,t){q(i,l,t),d(l,L),d(L,a),d(l,f),d(l,n),d(n,Z),d(l,u),d(l,e),_(c,e,null),d(l,m),_(s,l,null),o=!0},p:j,i(i){o||(y(c.$$.fragment,i),y(s.$$.fragment,i),o=!0)},o(i){H(c.$$.fragment,i),H(s.$$.fragment,i),o=!1},d(i){i&&p(l),x(c),x(s)}}}function R(r){const l=new K.Howl({src:[`${F}/assets/wheel/select.wav`]});return P(()=>{N("#the-wheel #slices path").on("click",L=>{l.play();let a=C(`#the-wheel #slices path#${L.target.id}`).node().classList.contains("highlighted");C(`#the-wheel #slices path#${L.target.id}`).classed("highlighted",!a)})}),z(()=>{l.unload()}),[]}class T extends D{constructor(l){super(),S(this,l,R,Q,W,{})}}function U(r){let l,L;return l=new T({}),{c(){w(l.$$.fragment)},l(a){$(l.$$.fragment,a)},m(a,f){_(l,a,f),L=!0},p:j,i(a){L||(y(l.$$.fragment,a),L=!0)},o(a){H(l.$$.fragment,a),L=!1},d(a){x(l,a)}}}class a5 extends D{constructor(l){super(),S(this,l,null,U,W,{})}}export{a5 as default};
