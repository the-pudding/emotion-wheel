import{S,i as W,s as j,k,q as A,a as g,v as w,l as M,m as Z,r as B,h as o,c as v,w as $,n as p,b as D,F as h,x as _,G as q,f as y,t as H,y as x,H as O,I as F,o as G,Z as P}from"../../../chunks/paths-b5311ced.js";import{I as z,C as J,k as K,l as N,s as C}from"../../../chunks/ClickableWheel-4b60b43d.js";import{s as Q}from"../../../chunks/misc-b41af6a7.js";const R=`<svg id="the-wheel" viewBox="0 0 1150 1121" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="slices">
...
`;function T(c){let l,L,a,e,i,r,u,s,n,m,f,b;return n=new z({props:{name:"download"}}),f=new J({props:{slices:R,imgSrc:"assets/wheel/wheel.png",wheelId:"the-wheel"}}),{c(){l=k("div"),L=k("a"),a=A("Back to the story"),e=g(),i=k("h1"),r=A("Hi, how are you feeling?"),u=g(),s=k("a"),w(n.$$.fragment),m=g(),w(f.$$.fragment),this.h()},l(t){l=M(t,"DIV",{class:!0});var d=Z(l);L=M(d,"A",{href:!0,class:!0});var I=Z(L);a=B(I,"Back to the story"),I.forEach(o),e=v(d),i=M(d,"H1",{class:!0});var V=Z(i);r=B(V,"Hi, how are you feeling?"),V.forEach(o),u=v(d),s=M(d,"A",{class:!0,download:!0,alt:!0});var E=Z(s);$(n.$$.fragment,E),E.forEach(o),m=v(d),$(f.$$.fragment,d),d.forEach(o),this.h()},h(){p(L,"href","../"),p(L,"class","svelte-12hs9pv"),p(i,"class","svelte-12hs9pv"),p(s,"class","download svelte-12hs9pv"),p(s,"download",""),p(s,"alt","download your emotion wheel"),p(l,"class","container svelte-12hs9pv")},m(t,d){D(t,l,d),h(l,L),h(L,a),h(l,e),h(l,i),h(i,r),h(l,u),h(l,s),_(n,s,null),h(l,m),_(f,l,null),b=!0},p:q,i(t){b||(y(n.$$.fragment,t),y(f.$$.fragment,t),b=!0)},o(t){H(n.$$.fragment,t),H(f.$$.fragment,t),b=!1},d(t){t&&o(l),x(n),x(f)}}}function U(c,l,L){let a;O(c,Q,i=>L(0,a=i));const e=new K.Howl({src:[`${F}/assets/wheel/select.wav`]});return G(()=>{N("#the-wheel #slices path").on("click",i=>{e.play();let r=C(`#the-wheel #slices path#${i.target.id}`).node().classList.contains("highlighted");C(`#the-wheel #slices path#${i.target.id}`).classed("highlighted",!r)})}),P(()=>{e.unload()}),c.$$.update=()=>{c.$$.dirty&1&&(a||e.mute(!0)),c.$$.dirty&1&&a&&e.mute(!1)},[a]}class X extends S{constructor(l){super(),W(this,l,U,T,j,{})}}function Y(c){let l,L;return l=new X({}),{c(){w(l.$$.fragment)},l(a){$(l.$$.fragment,a)},m(a,e){_(l,a,e),L=!0},p:q,i(a){L||(y(l.$$.fragment,a),L=!0)},o(a){H(l.$$.fragment,a),L=!1},d(a){x(l,a)}}}class i5 extends S{constructor(l){super(),W(this,l,null,Y,j,{})}}export{i5 as default};
